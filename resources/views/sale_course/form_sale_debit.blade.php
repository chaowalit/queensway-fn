...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" name="referent_payment_transfer" id="referent_payment_transfer" value="{{ (int)str_replace(',' ,'', $view_data['referent_payment_transfer']) }}" readonly="true" class="red">
												</div>
												<div class="col-sm-3">
