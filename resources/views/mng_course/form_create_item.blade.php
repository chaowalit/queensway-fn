...
<div class="main-content-inner">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">เพิ่มรายการคอร์ส (item)</li>
		</ul><!-- /.breadcrumb -->
	...
	<div class="page-content">
		...
		<div class="page-header">
			<h1>
				ฟอร์มเพิ่มรายการคอร์ส (item)
				<small>
					<i class="ace-icon fa fa-angle-double-right"></i>
					คุณสามารถเพิ่มรายการคอร์ส ได้ที่นี้
				</small>
			</h1>
		</div><!-- /.page-header -->
			...
			<div class="col-xs-12">
				...
				<form action="{{ url('mng_course/save_mng_course') }}" class="form-horizontal" role="form" method="POST">
						...
						<div class="col-sm-9">
							...
							<div class="col-xs-8 col-sm-4" style="padding-left: 0px;">
								<select class="form-control" id="category_item_id" name="category_item_id">
									...
									<option value="{{ $val->id }}" {{ ($val->id == old('category_item_id', ''))? 'selected':'' }}>{{ $val->category_item_name }}</option>
									@endforeach
								</select>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="item_name" id="item_name" placeholder="ชื่อคอร์สหรือไอเทม" class="col-xs-10 col-sm-5" value="{{ old('item_name', '') }}">
						</div>
					</div>
