    ...
    <table class="table table-striped table-bordered" style="text-align: center;">
        <thead>
            ...
            <tr>
                ...
                <th colspan="7" align="center">ยอดที่ใช้</th>
                <th colspan="2" align="center">คงเหลือ</th>
            </tr>
            <tr>
                <th></th>
                <th></th>
                ...
                <th align="center" width="12">ยอดวงเงินที่ซื้อ</th>
                ...
                <th align="center" width="12">ยอดวงเงินที่ใช้</th>
                <th align="center">ชื่อหมอ</th>
                <th align="center" width="12">ชื่อ Consult</th>
                <th align="center">ชื่อ BT/TT</th>
                <th align="center">คงเหลือ</th>
                <th align="center" width="12">วงเงินคงเหลือ</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($res as $key => $value) { ?>
                <tr>
                    ...
                    <td align="center"><?php echo $value[16]; ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
