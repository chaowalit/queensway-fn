$(document).ready(function() {
	$("#nav-search-input").keyup(function() {
		...
		result_search_customer_use_course(keyword, column_name);
	});

	$("#column_name").change(function() {
		$("#nav-search-input").val('');
		result_search_customer_use_course($("#nav-search-input").val(), $(
			"#column_name").val());
	});
	if ($("#column_name").val()) {
		result_search_customer_use_course($("#nav-search-input").val(), $(
...
function result_search_customer_use_course(keyword, column_name) {
	...
	$.ajax({
		url: 'ajax_search_customer_use_course',
		data: {
			'keyword': keyword,
